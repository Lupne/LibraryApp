...
export default function Library(){
  ...
  <FlatList data={obj} numColumns={2} renderItem={({item})=>{
    return(
      ...
      <View style={{flexDirection:'row',marginTop:5}}><AntDesign name="book" size={30} color="black" /><View style={{marginLeft:47,marginRight:47}}><AntDesign name="infocirlce" size={30} color="black" /></View><AntDesign name="star" size={30} color="black" /></View>
      </Card>
      </TouchableOpacity>
    )
  }} />
